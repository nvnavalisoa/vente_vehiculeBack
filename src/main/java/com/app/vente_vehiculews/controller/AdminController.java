...
public class AdminController {
    ...
    public AdminController(AdminRepository adminrepo, AuthTokenRepository authtokenrepo, CategorieRepository categorepo, MarqueRepository marquerepo, ModeleRepository modelerepo, AnnonceRepository annonceRepository) {
    ...
    @GetMapping("/annonces")
    public List<AnnonceDetails> Tovalidate(){
        return annonceRepository.listAnnonceFront(false);
    }

    //validation annonce
    @PutMapping("/annonces/{idannonce}")
    public void ValidationAnnonce(@PathVariable("idannonce") int idannonce){
        annonceRepository.updateValidationAnnonce(true, idannonce);
    }
